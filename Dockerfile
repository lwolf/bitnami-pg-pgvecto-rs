ARG PGVECTORS_TAG=pg17-v0.3.0-amd64
...
ADD "https://github.com/tensorchord/pgvecto.rs/releases/download/v0.3.0/vectors-pg17_0.3.0_amd64_public.deb" /tmp/vectors.deb
USER root
